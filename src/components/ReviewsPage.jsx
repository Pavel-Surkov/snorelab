					...
					<div className="row">
						<div className="col-12 col-lg-9">
							<div className="reviews-page__info">
								<h1 className="title title_fade title_size-l reviews-page__title">Reviews</h1>
								<span className="reviews-page__subtitle">A selection of our favorite user reviews</span>
								<p>
									SnoreLab has an average rating of 4.5 stars from more than 10,000 user reviews. Have
									a look at our{' '}
									<a className="link" href="#">
										SnoreLab Success Stories
									</a>{' '}
									to see the different ways that you&nbsp;can&nbsp;get your snoring under control.
								</p>
							</div>
						</div>
					</div>
