			...
			<div className="description-wrapper">
				<div className="container">
					<div className="description__info">
						...
						<p>
							SnoreLab has helped millions of people to understand their snoring problem and to discover
							solutions to improve their sleep.
						</p>
					</div>
					<div className="row">
						...
						<div className="col-12 col-lg-6">
							<ul className="description__list">
								{descriptionCards.map(card => (
									<li className="description__item" key={card.title}>
										<div className="description__item-wrapper">
											<div className="description__item-icon">
												<img src={card.icon} alt="description icon" />
											</div>
				...
				<svg width="462" height="1003" viewBox="0 0 462 1003" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path
