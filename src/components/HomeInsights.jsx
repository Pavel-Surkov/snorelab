...
export const HomeInsights = () => {
  ...
  const tags = useFetch(
    'https://snorelab.ux-mind.pro/wp-json/wp/v2/categories?per_page=100',
    {}
  )
  ...
  return (
    <section className="home-insights">
      <div className="home-insights__wrapper">
        ...
        <LazyLoadImage className="bg-light-3 changed" alt="" src={ellipse} />
        {/*<svg
          data-svg="decorative"
          width="379"
          height="371"
